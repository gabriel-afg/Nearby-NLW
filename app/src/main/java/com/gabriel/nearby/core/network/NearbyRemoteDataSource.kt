package com.gabriel.nearby.core.network

import com.gabriel.nearby.core.network.KtorHttpClient.httpClientAndroid
import com.gabriel.nearby.data.model.Category
import com.gabriel.nearby.data.model.Coupon
import com.gabriel.nearby.data.model.Market
import com.gabriel.nearby.data.model.MarketDetails
...
object NearbyRemoteDataSource {
    ...
    private const val LOCAL_HOST_PHYSICAL_BASE_URL = "http://SEU_SUB_DOMINIO:3333"
