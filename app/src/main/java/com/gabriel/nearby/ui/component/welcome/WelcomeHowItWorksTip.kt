package com.gabriel.nearby.ui.component.welcome
...
import com.gabriel.nearby.ui.theme.Gray500
import com.gabriel.nearby.ui.theme.RedBase
...
private fun WelcomeHowItWorksTipPreview() {
    WelcomeHowItWorksTip(title = "Titulo", subtitle = "Subtitulo", iconRes = R.drawable.ic_tools_kitchen_2);
}
